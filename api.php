...
if (isset($_GET['protocol']) && isset($_GET['projectName']) && isset($_GET['eventName'])) {
    ...
    if (in_array($protocol, $allowedProtocols)) {
        ...
        switch ($protocol) {
            ...
            // Generated by IOPT API for your '$projectName' project.
            // All generated code is intended for the net_io file.
            // Keep in mind if you use this protocol multiple times to implement
            // different events you will get duplicated code, in that case add only what is different.
            // ===================================================================
            ...
            */
            ...
            volatile bool $flagName = false; // flag only for receiving signals
            ...
            */
            ...
            if ($flagName == true) {
                events->$eventName = 1;
                $flagName = false; // Reset the flag to fire only once
            } else {
                events->$eventName = 0; // Ensure the event is inactive by default
            }
        ...
        // ===================================================================
        // Receiver Controller (listens for event: '$eventName')
        // ===================================================================
        ...
        */
        ...
        // ===================================================================
        // Sender Controller (sends event: '$eventName')
        // ===================================================================
